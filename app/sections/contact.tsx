        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div>
            ...
            <motion.a
              ...
              href={`mailto:${EMAIL}`}
              className="inline-flex items-center gap-2 text-[14px] font-semibold text-foreground hover:text-accent transition-colors duration-200 mb-10 group"
            >
            ...
            >
              {socials.map(({ label, href, icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="flex items-center justify-center w-10 h-10 rounded-xl border border-foreground/10 text-muted hover:text-accent hover:border-accent/40 transition-all duration-200"
                >
                  {icon}
                </a>
              ))}
